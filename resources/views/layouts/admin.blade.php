                ...
                <div class="bg-dark p-2">
                  ...
                  <ul class="nav nav-pills flex-column mt-4">
                    <li class="nav-item py-2 py-sm-0">
                      <a href="/admin/pelajaran" class="nav-link text-white">
                        <i class="fs-4 bi bi bi-activity"></i></i></i><span class="fs-5 ms-3 d-none d-sm-inline">Pelajaran</span>
                      </a>
                    </li>
                    <li class="nav-item py-2 py-sm-0">
                      <a href="/admin/account" class="nav-link text-white">
                        <i class="fs-4 bi bi-person-add"></i></i><span class="fs-5 ms-3 d-none d-sm-inline">Informasi Akun</span>
                      </a>
                    </li>
                    <li class="nav-item py-2 py-sm-0">
                        <a href="/admin/kelas" class="nav-link text-white">
                          <i class="fs-4 bi bi-people-fill"></i></i><span class="fs-5 ms-3 d-none d-sm-inline">Kelas</span>
                        </a>
                      </li>
                  </ul>
                </div>
